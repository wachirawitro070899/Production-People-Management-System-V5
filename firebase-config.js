// PPMS Firebase Realtime Database configuration
// Project: JRTL-Organization / wachirawit-c8582
// IMPORTANT: Create Realtime Database in Singapore (asia-southeast1) before use.
window.PPMS_FIREBASE_CONFIG = {
