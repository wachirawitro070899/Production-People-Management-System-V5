...
function stampingHierarchy(report,footer){
 ...
 const html=`<h2>STAMPING SECTION – STANDARD ORGANIZATION CHART</h2><p>โครงสร้างตามลำดับตำแหน่ง / Position Hierarchy</p><div class="stamping-section-banner">Stamping Section</div><div class="panel hierarchy">${levels||'<div class="empty">ไม่มีข้อมูลพนักงาน</div>'}</div>`;
